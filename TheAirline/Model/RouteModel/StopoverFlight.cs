...
namespace TheAirline.Model.RouteModel
{
    ...
    public class StopoverFlight : Flight
    {
        ...
        public void SetNextEntry()
        {
            ...
            if (CurrentFlight == 0)
            {
                FlightTime = MathHelpers.ConvertEntryToDate(Entry, 0);
            }
            else
            {
                FlightTime =
                    GameObject.GetInstance().GameTime.Add(FleetAirlinerHelpers.GetMinTimeBetweenFlights(Airliner));
            }
        ...
        {
            return CurrentFlight == Math.Max(AllClasses.Keys.Count, AllCargo.Keys.Count);
