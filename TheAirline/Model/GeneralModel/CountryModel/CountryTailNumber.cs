...
namespace TheAirline.Model.GeneralModel.CountryModel
{
    ...
    public class CountryTailNumber : ISerializable
    {
        ...
        private CountryTailNumber(SerializationInfo info, StreamingContext ctxt)
        {
            ...
            IEnumerable<FieldInfo> fields = GetType().GetFields(BindingFlags.Instance | BindingFlags.NonPublic | BindingFlags.Public).Where(p => p.GetCustomAttribute(typeof (Versioning)) != null);

            IList<PropertyInfo> props =
                new List<PropertyInfo>(GetType().GetProperties(BindingFlags.Instance | BindingFlags.NonPublic | BindingFlags.Public).Where(p => p.GetCustomAttribute(typeof (Versioning)) != null));
            ...
            IEnumerable<MemberInfo> notSetProps = propsAndFields.Where(p => ((Versioning) p.GetCustomAttribute(typeof (Versioning))).Version > version);
        ...
        public virtual void GetObjectData(SerializationInfo info, StreamingContext context)
        {
            ...
            IEnumerable<FieldInfo> fields = myType.GetFields(BindingFlags.Instance | BindingFlags.NonPublic | BindingFlags.Public).Where(p => p.GetCustomAttribute(typeof (Versioning)) != null);

            IList<PropertyInfo> props =
                new List<PropertyInfo>(myType.GetProperties(BindingFlags.Instance | BindingFlags.NonPublic | BindingFlags.Public).Where(p => p.GetCustomAttribute(typeof (Versioning)) != null));
        ...
        public string GetNextTailNumber()
        {
            ...
            try
            {
                ...
                if (numberFormat.Contains("\\d") && !numberFormat.Contains("\\s"))
                {
                    ...
                    format += "}";
                     * */
                    LastTailNumber = countryID + "-" + getTailNumber(number, length); ///String.Format(format, number);
                }
                if (numberFormat.Contains("\\s") && !numberFormat.Contains("\\d"))
                {
