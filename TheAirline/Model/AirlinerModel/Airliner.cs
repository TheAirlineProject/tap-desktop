...
namespace TheAirline.Model.AirlinerModel
{
    ...
    public class Airliner : BaseModel
    {
        ...
        {
            get { return EngineType == null ? Type.CruisingSpeed : Math.Min(Type.CruisingSpeed, EngineType.MaxSpeed); }
        }

        public long MinRunwaylength
        {
            get { return EngineType == null ? Type.MinRunwaylength : Convert.ToInt64(Type.MinRunwaylength*EngineType.RunwayModifier); }
        }

        public long Range
        {
            get { return EngineType == null ? Type.Range : Convert.ToInt64(Type.Range*EngineType.RangeModifier); }
        }
        ...
        public long GetPrice()
        {
            ...
            double facilityPrice = (from aClass in classes
