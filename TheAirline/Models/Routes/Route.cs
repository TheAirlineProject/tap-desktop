...
namespace TheAirline.Models.Routes
{
    ...
    public abstract class Route : BaseModel
    {
        #region Constants
        ...
        protected Route(SerializationInfo info, StreamingContext ctxt) : base(info, ctxt)
        {
            if (Version == 1)
            {
        ...
        public bool HasAirliner => GetAirliners().Count > 0;

        public bool HasStopovers => Stopovers.Count > 0;
        ...
        public bool IsCargoRoute => Type == RouteType.Cargo;
        ...
        public bool ContainsDestination(Airport destination)
        {
        ...
        {
            var dests = new List<Airport> {Destination1, Destination2};
