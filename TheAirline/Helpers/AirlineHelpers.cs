...
namespace TheAirline.Helpers
{
    ...
    public class AirlineHelpers
    {
        ...
        public static bool CheckSpecialContract(SpecialContract sc)
        {
            bool isOk = true;
            ...
            bool overdue = sc.Type.IsFixedDate ? GameObject.GetInstance().GameTime > sc.Type.Period.To : GameObject.GetInstance().GameTime >= sc.Date;
        ...
        public static bool HasTrainingFacility(Airline airline, string airlinerfamily)
        {
        ...
        public static bool CanApplyForLoan(Airline airline, Loan loan)
        {
        ...
        public static bool HasAirlineLicens(Airline airline, Airport airport1, Airport airport2)
        {
